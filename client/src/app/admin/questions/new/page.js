    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex items-center gap-4 border-b border-white/5 pb-6">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-white tracking-tight">New Question</h1>
                    <p className="text-gray-400 text-sm mt-1">Add a new interview question to the bank</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-black/40 backdrop-blur-xl border border-white/5 rounded-2xl p-6 md:p-8">
                    ...
                    <p className="text-gray-500 text-sm mb-6">
                        Enter each point on a new line. Must-have gives 6 pts, Good-to-have gives 3 pts bonus.
                    </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleRubricChange}
                                    placeholder="e.g. Optimized space complexity"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleRubricChange}
                                    placeholder="e.g. Brute force approach"
