            ...
            <div className="w-full max-w-md p-4 relative z-10 animate-fade-in">
                <Card className="shadow-2xl shadow-primary/5 border-border">
                    <CardHeader className="text-center pb-2">
                        ...
                        <p className="text-muted-foreground text-sm mt-2">Sign in to continue your progress</p>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <label className="block text-xs font-medium text-muted-foreground uppercase tracking-wider">Email Address</label>
                                <input
                                    type="email"
                                    value={email}
